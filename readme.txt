...
2. Navigate to the directory where the project are located.
...
4. Running the exercises with the following commands:
	4.1 Exercise 1: List the contents of a directory
		java -cp src\main\java org.example.Exercise1

	4.2 Exercise 2: List a directory tree
		java -cp src\main\java org.example.Exercise2

	4.3 Exercise 3: Save the output to a TXT file
		java -cp src\main\java org.example.Exercise3

	4.4 Exercise 4: Read a TXT file
		java -cp src\main\java org.example.Exercise4

	4.5 Exercise 5: Serialize and deserialize an object
		java -cp src\main\java org.example.Exercise5
